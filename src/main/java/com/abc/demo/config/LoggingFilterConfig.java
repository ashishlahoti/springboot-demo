...
@Configuration
@ConditionalOnExpression("${app.api.show-request-response:true}")
public class LoggingFilterConfig implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		try {
			...
			final StringBuilder logRequest = new StringBuilder("API_REQUEST- ")
					.append("[METHOD:").append(httpServletRequest.getMethod())
					.append("] [URI:").append(httpServletRequest.getServletPath())
			...
			try {
				chain.doFilter(bufferedRequest, bufferedResponse);
		   		...
		   		final StringBuilder logResponse = new StringBuilder("API_RESPONSE- [BODY:")
